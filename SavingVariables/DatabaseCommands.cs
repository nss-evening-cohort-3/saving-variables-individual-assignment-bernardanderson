...
namespace SavingVariables
{
    public class DatabaseCommands
    {
        ...
        public bool IsVariableAlreadyPresentForAdd(UserEntryData sentUserEntryDataForAdd)
        {
            ...
            int variableFound = Context.VariablesTable.Where(b => b.VariableName == sentUserEntryDataForAdd.UserVariable).Count();
        ...
        public UserEntryData AddVariable(UserEntryData sentUserEntryDataForAdd)
        {
            ...
            sentUserEntryDataForAdd.consoleOutputString = $"   Saved '{sentUserEntryDataForAdd.UserVariable}' as '{sentUserEntryDataForAdd.UserNumericValue}'";
